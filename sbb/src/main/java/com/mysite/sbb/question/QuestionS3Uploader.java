...
@Service
public class QuestionS3Uploader {
	
    private final AmazonS3 amazonS3;
    private final String bucketName;
    
    public QuestionS3Uploader(AmazonS3 amazonS3, @Value("${cloud.aws.s3.bucketName}") String bucketName) {
    ...
    public String updateFile(MultipartFile newFile, String dirName)throws IOException {
        // 기존 파일 삭제
